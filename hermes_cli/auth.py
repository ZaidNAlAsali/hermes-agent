...
def resolve_provider(
    ...
    *,
    ...
    # win over a stale logged-in OAuth `active_provider`. Order:
    #   1. config.yaml `model.provider`  2. env-var API keys  3. OpenRouter pool
    #   4. auth.json `active_provider` (OAuth)  5. Bedrock  6. error.
